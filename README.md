...
This Repository serves as a showcase of my learning process. Homeworks and projects completed during the course are collected here.

## 🛠️ Tech Stack
This course focuses on the core pillars of frontend web development, and all projects here are built using:
...
* 📂 `Week-06/` - TBA
* 📂 `Bonus_Week/` - TBA
* 📂 `Projects/` - Final Projetc(s) is showcased here

* ## 🚀 How to Run Locally
Since this repository consists of static frontend files, running the code is simple:
1. Clone the repository to your local machine
2. For the environment, I suggest to use 
